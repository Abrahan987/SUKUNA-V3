...
export async function smsg(client, m, store) {
      ...
      try {
        if (/^https?:\/\//.test(content)) {
          ...
          if (/gif|image|video|audio|pdf|stream/i.test(mime)) {
            return client.sendFile(chat, data.data, '', caption, quoted, false, { mimetype: mime })
          } else {
  ...
  m.copy = () => smsg(client, proto.WebMessageInfo.fromObject(proto.WebMessageInfo.toObject(m)))
