export default {
  ...
  run: async (client, m, args, usedPrefix, command) => {
    ...
    const hasImage = Boolean(
      ...
      src.mtype === "imageMessage" ||
      src.mimetype === "image" ||
      src.mediaType === "image",
    );
    const hasVideo = Boolean(
      src.message?.videoMessage ||
      src.mtype === "videoMessage" ||
      src.mimetype === "video" ||
      src.mediaType === "video",
    );
    const hasAudio = Boolean(
      src.message?.audioMessage ||
      src.mtype === "audioMessage" ||
      src.mimetype === "audio" ||
      src.mediaType === "audio",
    );
    const hasSticker = Boolean(
      src.message?.stickerMessage ||
      src.mtype === "stickerMessage" ||
      src.mimetype === "sticker" ||
      src.mediaType === "sticker",
    );
