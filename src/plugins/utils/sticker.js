  ...
  run: async (client, m, args, usedPrefix, command) => {
    try {
      ...
      if (/image/.test(mime)) {
        ...
        let encmedia = await client.sendImageAsSticker(m.chat, tmpFile, m, {
          packname: pack,
          author: author,
        });
        ...
        if ((quoted.msg || quoted).seconds > 20) {
          return m.reply(
            "☢︎︎ 𝙴𝚕 𝚟𝚒𝚍𝚎𝚘 𝚗𝚘 𝚙𝚞𝚎𝚍𝚎 𝚍𝚎𝚖𝚘𝚛𝚊𝚛 𝚖𝚊𝚜 𝚍𝚎 20 𝚜𝚎𝚐𝚞𝚗𝚍𝚘𝚜, 𝚛𝚎𝚌𝚘𝚛𝚝𝚊𝚕𝚘 𝚎 𝚒𝚗𝚝𝚎𝚗𝚝𝚊 𝚍𝚎 𝚗𝚞𝚎𝚟𝚘.",
          );
        }
        let buffer = await quoted.download();
        let encmedia = await client.sendVideoAsSticker(m.chat, buffer, m, {
          packname: pack,
          author: author,
        });
      } else {
        return client.reply(
          m.chat,
          "𖦹 𝙽𝚎𝚌𝚎𝚜𝚒𝚝𝚘 𝚞𝚗𝚊 𝚒𝚖𝚊𝚐𝚎𝚗 𝚘 𝚞𝚗 𝚟𝚒𝚍𝚎𝚘 𝚙𝚊𝚛𝚊 𝚝𝚛𝚊𝚗𝚜𝚏𝚘𝚛𝚖𝚊𝚛 𝚊 𝚜𝚝𝚒𝚌𝚔𝚎𝚛.",
          m,
        );
      }
    } catch (e) {
