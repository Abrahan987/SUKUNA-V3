export default {
  ...
  run: async (client, m, args, usedPrefix, command, text) => {
    ...
    if (restante > 0) {
      return m.reply(`☢︎︎ 𝙰𝚞́𝚗 𝚍𝚎𝚋𝚎𝚜 𝚎𝚜𝚙𝚎𝚛𝚊𝚛 *${msToTime(restante)}* 𝚙𝚊𝚛𝚊 𝚎𝚗𝚟𝚒𝚊𝚛 𝚘𝚝𝚛𝚘 𝚖𝚎𝚗𝚜𝚊𝚓𝚎.`)
    }
    ...
    if (texto.length < 10) {
      return m.reply(`☢︎︎ 𝚃𝚞 𝚖𝚎𝚗𝚜𝚊𝚓𝚎 𝚎𝚜 𝚖𝚞𝚢 𝚌𝚘𝚛𝚝𝚘, 𝚎𝚡𝚙𝚕𝚒́𝚌𝚊𝚕𝚘 𝚖𝚎𝚓𝚘𝚛 (𝚖𝚒́𝚗𝚒𝚖𝚘 10 𝚌𝚊𝚛𝚊𝚌𝚝𝚎𝚛𝚎𝚜).`)
    }
    ...
    const encabezado = esReporte ? '☢︎︎ 𝚁𝚎𝚙𝚘𝚛𝚝𝚎 𝚁𝚎𝚌𝚒𝚋𝚒𝚍𝚘' : '☢︎︎ 𝚂𝚞𝚐𝚎𝚛𝚎𝚗𝚌𝚒𝚊 𝙴𝚗𝚟𝚒𝚊𝚍𝚊'
