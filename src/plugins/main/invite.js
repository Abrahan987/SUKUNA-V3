...
const linkRegex =
  /chat\.whatsapp\.com\/([0-9A-Za-z]{20,24})(?:\s+[0-9]{1,3})?/i;
...
export default {
  ...
  run: async (client, m, args) => {
    ...
    if (!args || !args.length) {
      return m.reply("☢︎︎ 𝙳𝚎𝚋𝚎𝚜 𝚒𝚗𝚐𝚛𝚎𝚜𝚊𝚛 𝚞𝚗 𝚎𝚗𝚕𝚊𝚌𝚎 𝚍𝚎 𝚒𝚗𝚟𝚒𝚝𝚊𝚌𝚒𝚘́𝚗.");
    }
    ...
    if (!match || !match[1]) {
      return m.reply("☢︎︎ 𝙴𝚕 𝚎𝚗𝚕𝚊𝚌𝚎 𝚒𝚗𝚐𝚛𝚎𝚜𝚊𝚍𝚘 𝚗𝚘 𝚎𝚜 𝚟𝚊́𝚕𝚒𝚍𝚘 𝚘 𝚎𝚜𝚝𝚊́ 𝚒𝚗𝚌𝚘𝚖𝚙𝚕𝚎𝚝𝚘.");
    }

    const isPrincipalBot =
      botId === global.client.user.id.split(":")[0] + "@s.whatsapp.net";

    const botType = isPrincipalBot ? "𝙱𝚘𝚝 𝙿𝚛𝚒𝚗𝚌𝚒𝚙𝚊𝚕" : "𝚂𝚞𝚋 𝙱𝚘𝚝";
