...
export default {
  ...
  run: async (client, m, args, usedPrefix, command, text) => {
    ...
    if (!quoted) return m.reply( '𓁹 𝚁𝚎𝚜𝚙𝚘𝚗𝚍𝚎 𝚊 𝚞𝚗𝚊 𝚒𝚖𝚊𝚐𝚎𝚗 𝚍𝚎 𝚞𝚗𝚊 𝚜𝚘𝚕𝚊 𝚟𝚎𝚣 𝚙𝚊𝚛𝚊 𝚜𝚊𝚌𝚊𝚛 𝚜𝚞 𝚌𝚘𝚗𝚝𝚎𝚗𝚒𝚍𝚘.')
    try {
      await m.react('🕒')
      const content = extractMessageContent(quoted.message || quoted)
      if (!content) return m.reply('☹︎ 𝙴𝚛𝚛𝚘𝚛.')
      ...
      if (!stream) return m.reply('☹︎ No se pudo descargar el contenido.')
